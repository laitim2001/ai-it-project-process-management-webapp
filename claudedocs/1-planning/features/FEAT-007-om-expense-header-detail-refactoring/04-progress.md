...
| 任務 | 狀態 | 說明 |
|------|------|------|
| P3-01: 新增 OMExpenseItemForm | ⏳ | |
| P3-02: 新增 OMExpenseItemList | ⏳ | |
| P3-03: 實作拖曳排序 | ⏳ | |
| P3-04: 新增 OMExpenseItemMonthlyGrid | ⏳ | |
| P3-05: 重構 OMExpenseForm | ⏳ | |
| P3-06: 重構 OMExpenseMonthlyGrid | ⏳ | |
| P3-07: 重構 OMSummaryDetailGrid | ⏳ | |
| P3-08: 重構 OMSummaryCategoryGrid | ⏳ | |
| P3-09: 重構 OMSummaryFilters | ⏳ | |
| P3-10: 樣式和響應式設計 | ⏳ | |
...
| 任務 | 狀態 | 說明 |
|------|------|------|
| P4-01: 重構 om-expenses/new | ⏳ | |
| P4-02: 重構 om-expenses/[id] | ⏳ | |
| P4-03: 重構 om-expenses/[id]/edit | ⏳ | |
| P4-04: 更新 om-expenses 列表頁 | ⏳ | |
| P4-05: 更新 om-summary | ⏳ | |
| P4-06: 頁面整合測試 | ⏳ | |
...
| 任務 | 狀態 | 說明 |
|------|------|------|
| P5-01: 新增 zh-TW.json 鍵值 | ⏳ | |
| P5-02: 新增 en.json 鍵值 | ⏳ | |
| P5-03: 執行 validate:i18n | ⏳ | |
| P5-04: 執行 typecheck | ⏳ | |
| P5-05: 執行 lint | ⏳ | |
| P5-06: 代碼審查 | ⏳ | |
